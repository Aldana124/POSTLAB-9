...
# 27 "POSTLABORATORIO 9.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\c90\\stdint.h" 1 3
# 28 "POSTLABORATORIO 9.c" 2
# 43 "POSTLABORATORIO 9.c"
unsigned short PULSO1 = 0, PULSO2 = 0;
uint8_t contador = 0;
int POT = 0;
...
void __attribute__((picinterrupt(("")))) isr (void){
    ...
    if(PIR1bits.ADIF){
        ...
        if(ADCON0bits.CHS == 0){
            PULSO1 = map(ADRESH, 0, 255, 250, 500);
            CCPR1L = (uint8_t)(PULSO1>>2);
            CCP1CONbits.DC1B = PULSO1 & 0b11;
        }

        else if(ADCON0bits.CHS == 1){
            PULSO2 = map(ADRESH, 0, 255, 250, 500);
            CCPR2L = (uint8_t)(PULSO2>>2);
            CCP2CONbits.DC2B0 = PULSO2 & 0b01;
            CCP2CONbits.DC2B1 = (PULSO2 & 0b10)>>1;
        }
